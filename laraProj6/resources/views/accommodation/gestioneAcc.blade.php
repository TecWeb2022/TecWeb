               ...
               <ol class="optionlist ">
                  ...
                  <li class="flex-box flex-row">
                     ...
                     <div class="column seven">
                        ...
                        <span>
                        @if($acc->assegnato)
                            <img class="icona_posizione" src="{{ URL::asset('/images/blue-icon.png') }}" title="Offerta assegnata" alt="">
                        @elseif($acc->fine_disp <= now())
                            <img class="icona_posizione" src="{{ URL::asset('/images/red-icon.png') }}" title="Offerta scaduta" alt="">
                        @endif
                        </span>
                            </h3>
